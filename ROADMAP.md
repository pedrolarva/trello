...
- **Dependencies & Risks:** None significant. Users need to be aware of manual backup procedures.
...
- **Dependencies & Risks:** Changes the core data structure heavily; risk of breaking existing data on update.
...
- **Dependencies & Risks:** Handling different time zones and daylight saving changes.
...
- **Estimated effort:** Large
- **Dependencies & Risks:** Requires setting up a backend service (e.g. Firebase), potential data conflicts during sync.
